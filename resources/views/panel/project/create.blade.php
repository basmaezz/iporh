@php
    $breadcrumb_array = [];
    array_push($breadcrumb_array,collect(['is_last'=>true,'name'=>'إضافة مشروع','link'=> '#']));
    array_push($breadcrumb_array,collect(['is_last'=>false,'name'=>'المشاريع','link'=> lang_route('panel.project.all')]));
@endphp

@extends('panel.layouts.index',['sub_title'=>'إضافة مشروع جديد' ,'breadcrumb_array'=> $breadcrumb_array])
@section('main')
    @push('panel_css')
    ...
    <div class="content">
        {!! Form::open(['id'=>'form','method'=>'POST','url'=>lang_route('panel.project.create'),'to'=>lang_route('panel.project.all')]) !!}
