@php
    $breadcrumb_array = [];
    array_push($breadcrumb_array,collect(['is_last'=>true,'name'=>'الأخبار','link'=> lang_route('panel.post.all')]));
@endphp
@extends('panel.layouts.index',['sub_title'=>'عرض الأخبار' ,'breadcrumb_array'=> $breadcrumb_array])
@section('main')
    @push('panel_css')
                ...
                <div class="table-responsive">
                    ...
                    <table id="table1" class="table table-bordered table-hover" data-name="cool-table">
                        <caption class="bottom">
                            <button  class="btn btn-default" onclick="window.open('/admin/post/create')">إضافة جديد
    ...
    @push('panel_js')
        ...
        <script>
            var url = '{{lang_route('panel.post.all.data')}}';
