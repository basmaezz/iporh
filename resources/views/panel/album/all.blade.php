@php
    $breadcrumb_array = [];
    array_push($breadcrumb_array,collect(['is_last'=>true,'name'=>'الألبومات','link'=> lang_route('panel.album.all')]));
@endphp
@extends('panel.layouts.index',['sub_title'=>'عرض الألبومات' ,'breadcrumb_array'=> $breadcrumb_array])
@section('main')
    @push('panel_css')
                ...
                <div class="table-responsive">
                    ...
                    <table id="table1" class="table table-bordered table-hover" data-name="cool-table">
                        <caption class="bottom">
                            <button  class="btn btn-default" onclick="window.open('/admin/album/create')">إضافة جديد
