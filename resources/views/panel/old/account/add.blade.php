...
@section('main')
    ...
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> الصفحة الرئيسية <span>   حسابات الإدارة /  إنشاء حساب جديد   </span></h2>
    </div>
    <div class="contentpanel">
        <div class="row">
            {!! Form::open(['id'=>'form','url'=>admin_url('account/create'),'to'=>admin_url('account/all')]) !!}
            <div class="col-md-8">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row btn-padding">
                            <button style="width: 80%" class=" btn btn-primary">إضافة&nbsp; &nbsp;
                            ...
                            <form id="single" action="{{csrf_token()}}">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="fileinput-new thumbnail"
                                        ...
                                        <img src="{{url('/image/300x300/default.png')}}" data-src="holder.js/100%x100%"
                                             alt="">
                                    </div>
