@extends('panel.layouts.index',['sub_title'=>'Edit Story'])
@section('main')
    @push('panel_css')
        {!! HTML::style('panel/css/jasny-bootstrap.min.css') !!}
    @endpush
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> Dashboard <span> Stories / Edit </span></h2>
    </div>
    <div class="contentpanel">
        <div class="row">
            {!! Form::open(['id'=>'form','method'=>'PUT','url'=>lang_route('panel.story.edit',['id'=>$story->id]),'to'=>lang_route('panel.story.all')]) !!}
            <div class="col-md-8">
                <input type="hidden" id="photo" name="image" value="{{$story->image}}">
                <div class="panel panel-default">
                    <div class="panel-body">
                            ...
                            <div class="tab-pane active" id="home3">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="5" name="description" required>{{$story->description}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="margin-top: 10px;">
                                                <textarea class="form-control ckeditor" rows="15" name="text" required>{{$story->text}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane" id="profile3">
                                <div class="row">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" >Title </label>
                                        <div class="col-sm-9">
                                            <input type="text" name="title_ar"  value="{{$story->title_ar}}" class="form-control" required/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" >Description </label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="5" name="description_ar" required> {{$story->description_ar}}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="margin-top: 10px;">
                                                <textarea class="form-control ckeditor" rows="15" name="text_ar" required> {{$story->text_ar}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group" style="margin-top: 10%;">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="video" value="{{$story->video}}" class="form-control"/>
                            </div>
                        </div>
                        <div class="form-group" style="margin-top: 5%;">
                            <label class="control-label " style="text-align: center">Upload Images</label>
                            <div id="app">
                                <dropzone :images_data="{{json_encode([$story->images])}}"> </dropzone>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form id="single" action="{{csrf_token()}}">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div class="fileinput-new thumbnail"
                                        ...
                                        <img src="{{image_url($story->image,'300x300')}}" data-src="holder.js/100%x100%"
                                             alt="">
                                    </div>
